...
let autoGeneratedDeprecatedAPI: RegExp[] = []
...
const getDeprecatedLuauAPI = async () => {
	try {
		...
		autoGeneratedDeprecatedAPI = [...classes, ...functions, ...properties, ...enums].map(
...
export { autoGeneratedDeprecatedAPI, definitiveDeprecated, incorrectAPI, outputFilter, possibleDeprecated }
